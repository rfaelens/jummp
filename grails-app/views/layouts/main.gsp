...
<body>
    ...
    <div id="container">
        <div id="nav">
            ...
            <div class="right ${pageProperty(name: 'body.activetab') ? (pageProperty(name: 'body.activetab') == 'search' ? 'active' : '') : ''}"><a href="${g.createLink(controller: 'search', action: 'overlay')}"><g:message code="jummp.main.tabs.search"/></a></div>
        </div>
