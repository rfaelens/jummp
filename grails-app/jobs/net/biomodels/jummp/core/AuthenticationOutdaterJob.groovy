...
class AuthenticationOutdaterJob {
    ...
    static triggers = {
        simple name: 'authenticationRemoveTrigger', startDelay: ConfigurationHolder.config. jummp.authenticationHash.startRemoveOffset, repeatInterval: ConfigurationHolder.config.jummp.authenticationHash.removeInterval
    }
