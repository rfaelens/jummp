...
*
* If you modify Jummp, or any covered work, by linking or combining it with Grails, Spring Security and Perf4j (or a modified version of that
...
* code for the parts of Grails, Spring Security and Perf4j used as well as that of the covered work.}
**/
