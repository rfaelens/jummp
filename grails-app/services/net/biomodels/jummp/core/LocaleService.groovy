...
*
* If you modify Jummp, or any covered work, by linking or combining it with the Locale Variant plugin (or a modified version of that
...
* code for the parts of Locale Variant used as well as that of the covered work.}
**/
