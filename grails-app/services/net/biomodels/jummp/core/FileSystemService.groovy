...
*
* If you modify Jummp, or any covered work, by linking or combining it with Apache Commons, Perf4j and the Spring Framework (or a modified version of that
...
* code for the parts of Apache Commons, Perf4j and the Spring Framework used as well as that of the covered work.}
**/
