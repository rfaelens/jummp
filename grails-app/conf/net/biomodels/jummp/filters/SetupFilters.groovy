...
*
* If you modify Jummp, or any covered work, by linking or combining it with Spring Framework (or a modified version of that
* library), containing parts covered by the terms of Apache 2.0 license, the licensors of this Program grant you additional
...
* code for the parts of Spring Framework used as well as that of the covered work.}
**/
