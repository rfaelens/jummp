...
*
* If you modify Jummp, or any covered work, by linking or combining it with Grails (or a modified version of that
...
* code for the parts of Grails used as well as that of the covered work.}
**/
