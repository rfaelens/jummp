...
class MiriamServiceTests extends JummpIntegrationTest {
    ...
    void testQueueUrnForIdentifierResolving() {
        ...
        Model model = new Model(name: "test", vcsIdentifier: "test.xml", submissionId: "M1")
        Revision rev = new Revision(model: model, vcsId: "1", revisionNumber: 1, owner: User.findByUsername("testuser"), minorRevision: false, name:"",description:"", comment: "", uploadDate: new Date(), format: ModelFormat.findByIdentifier("UNKNOWN"))
    ...
    void testCreateGeneOntologyRelationships() {
        authenticateAsAdmin()
        Model model1 = new Model(name: "test1", vcsIdentifier: "test1.xml", submissionId: "M1")
        Revision revision1 = new Revision(model: model1, vcsId: "1", revisionNumber: 1, owner: User.findByUsername("testuser"), minorRevision: false, name:"",description:"", comment: "", uploadDate: new Date(), format: ModelFormat.findByIdentifier("UNKNOWN"))
        ...
        Model model2 = new Model(name: "test2", vcsIdentifier: "test2.xml", submissionId: "M2")
        Revision revision2 = new Revision(model: model2, vcsId: "2", revisionNumber: 1, owner: User.findByUsername("testuser"), minorRevision: false, name:"",description:"", comment: "", uploadDate: new Date(), format: ModelFormat.findByIdentifier("UNKNOWN"))
        ...
        Model model3 = new Model(name: "test3", vcsIdentifier: "test3.xml", submissionId: "M3")
        Revision revision3 = new Revision(model: model3, vcsId: "3", revisionNumber: 1, owner: User.findByUsername("testuser"), minorRevision: false, name:"",description:"", comment: "", uploadDate: new Date(), format: ModelFormat.findByIdentifier("UNKNOWN"))
