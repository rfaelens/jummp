...
class MiriamServiceTests extends JummpIntegrationTest {
    ...
    void testQueueUrnForIdentifierResolving() {
        ...
        Revision rev = new Revision(model: model, vcsId: "1", revisionNumber: 1, owner: User.findByUsername("testuser"), minorRevision: false, description:"", comment: "", uploadDate: new Date(), format: ModelFormat.findByIdentifier("UNKNOWN"))
    ...
    void testCreateGeneOntologyRelationships() {
        ...
        Revision revision1 = new Revision(model: model1, vcsId: "1", revisionNumber: 1, owner: User.findByUsername("testuser"), minorRevision: false, description:"", comment: "", uploadDate: new Date(), format: ModelFormat.findByIdentifier("UNKNOWN"))
        ...
        Revision revision2 = new Revision(model: model2, vcsId: "2", revisionNumber: 1, owner: User.findByUsername("testuser"), minorRevision: false, description:"", comment: "", uploadDate: new Date(), format: ModelFormat.findByIdentifier("UNKNOWN"))
        ...
        Revision revision3 = new Revision(model: model3, vcsId: "3", revisionNumber: 1, owner: User.findByUsername("testuser"), minorRevision: false, description:"", comment: "", uploadDate: new Date(), format: ModelFormat.findByIdentifier("UNKNOWN"))
