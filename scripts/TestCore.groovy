...
* Apache Commons, JGit, Spring Framework (or a modified version of that library), containing parts
...
* include the source code for the parts of Apache Commons, JGit, Spring Framework used as well as
