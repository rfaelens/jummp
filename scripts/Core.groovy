...
<sbml xmlns="http://www.sbml.org/sbml/level1" level="1" version="1">
  <model>
    ...
    modelService.uploadModel(modelFile, modelTransportCommandClass.newInstance(format: modelFormatClass.newInstance(identifier: "SBML"), comment: "Test", name: "1st model"))
    modelService.uploadModel(modelFile, modelTransportCommandClass.newInstance(format: modelFormatClass.newInstance(identifier: "SBML"), comment: "Test", name: "2nd model"))
