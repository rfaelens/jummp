...
class ColumnMapValue {
    ...
    public ColumnMapValue(SymbolRef symbRef, List<CategoryMapping> _categoryMaps) {
        ...
        symbol = symbRef.symbIdRef
        categoryMaps = _categoryMaps
    }

    @Override
    @Profiled(tag = "columnMapValue.toString")
    public String toString() {
        return "ColumnMapValue($symbol, ${categoryMaps.inspect})"
    }
}
