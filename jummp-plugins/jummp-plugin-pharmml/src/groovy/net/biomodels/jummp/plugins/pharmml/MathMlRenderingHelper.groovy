...
class MathMlRenderingHelper {
    ...
    static String convertToMathML(def equation, Map<String, Equation> transfMap = [:]) {
    ...
    static String convertToMathML(String lhs, def equation, Map<String, Equation> transfMap = [:]) {
        StringBuilder builder=new StringBuilder("<math display='inline'><mstyle>")
    ...
    static String convertToMathML(EquationType lhs, EquationType rhs, Map<String, Equation> transfMap = [:]) {
    ...
    static String convertToMathML(String lhs, ScalarRhs srhs, Map<String, Equation> transfMap = [:]) {
         if (srhs.equation) {
    ...
    static String convertToMathML(String lhs, Rhs rhs, Map<String, Equation> transfMap = [:]) {
        if (rhs.equation) {
    ...
    static String convertToMathML(DerivativeVariableType derivative, def iv) {
    ...
    static String convertToMathML(String lhs, List arguments, def equation) {
        StringBuilder builder=new StringBuilder("<math display='inline'><mstyle>")
        builder.append(oprand(lhs))
        builder.append(op("("))
    ...
    static void convertToMathML(String name, def matrix, List ipNames, StringBuilder output) {
    ...
    static JAXBElement wrapJaxb(def elem) {
        return elem instanceof JAXBElement ? elem : new JAXBElement(new QName(""), elem.getClass(), elem)
    }

    static JAXBElement applyBinopToList(List elements, String operator) {
        if (elements.size() == 1) {
     ...
     */
    static EquationType resolveSymbolReference(SymbolRefType ref, Map<String, Equation> transfMap) {
    ...
    static void populateRandomVariableMap(final String id, final String level, Map rv) {
