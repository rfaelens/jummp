...
//TODO make it return a Model section with a binder that handles publication details
class DefaultMetadataInputSource implements MetadataInputSource {
    boolean supports(RevisionTransportCommand revision) {
        println "default mis does not support any format"
        false
    }
