...
class JummpPluginAnnotationCoreGrailsPlugin {
    ...
    def loadBefore = [
            ...
            'jummp-plugin-annotation-source-ddmore'
    ]
    ...
    def title = "Jummp Plugin Annotation Core Plugin" // Headline display name of the plugin
...
'''
    ...
    def documentation = "http://grails.org/plugin/jummp-plugin-annotation-core"
