            ...
            $.ajax({
                ...
                "success": function (json) {
                    ...
                    for (i = 0; i < json.aaData.length; i += 1) {
                        ...
                        id = json.modelIDs[i]
                        rowData[0] = "<a href=\"" + $.jummp.createLink("model", "model", id) + "\">" + (rowData[0] ? rowData[0].replace(/_/g, " ") : "-") + "</a>";
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (i = 0; i < data.length; i += 1) {
                ul.append("<li><a href=\"" + $.jummp.createLink("model", "model", data[i].id) + "\">" + data[i].name.replace(/_/g, " ") + "</a><br/>" + $.i18n.prop("model.history.submitter") + " " + data[i].submitter+"</li>");
            }
