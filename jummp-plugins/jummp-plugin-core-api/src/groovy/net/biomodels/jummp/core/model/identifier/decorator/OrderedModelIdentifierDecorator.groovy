...
/**
 * @Short Extension of ModelIdentifierDecorator to provide comparison capabilities.
 *
 * Concrete implementations of this interface can be sorted according to their natural
 * order.
 */
