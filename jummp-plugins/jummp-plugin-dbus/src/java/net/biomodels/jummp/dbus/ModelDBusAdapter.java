...
public interface ModelDBusAdapter extends DBusInterface {
    ...
    public DBusModel uploadModel(String authenticationHash, List<String> fileName, DBusModel meta);
    public DBusModel uploadModelWithPublication(String authenticationHash, List<String> fileName, DBusModel meta, DBusPublication publication);
