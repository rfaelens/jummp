...
class DBusModel extends ModelTransportCommand implements DBusSerializable {
    ...
    public void deserialize(long id, String name, String state, String format, String comment, long lastModifiedDate, String submitter, long submissionDate, String[] creators) {
        this.id = id
        this.name = name
        //this.state =
