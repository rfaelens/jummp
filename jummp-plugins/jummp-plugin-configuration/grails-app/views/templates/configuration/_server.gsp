<div class="dialog">
    <table class="formtable">
        <tbody>
            ...
            <tr class="prop">
                <td class="name"><label for="url" title="The web servers production URL">URL:</label></td>
                <td class="value ${hasErrors(bean: server, field: 'weburl', 'errors')}">
                    <input type="text" name="url" id="url" value="${server ? server.weburl : 'http://127.0.0.1:8080/jummp-web-application/'}" title="The web servers production URL"/>
                </td>
            </tr>
        </tbody>
    </table>
