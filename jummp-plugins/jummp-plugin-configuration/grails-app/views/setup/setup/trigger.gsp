...
<html>
    ...
    <body>
        <div id="remote" class="body">
            <h1>User Remove Trigger Configuration</h1>
            <h5>All times are in milliseconds</h5>
            <g:form name="triggerForm" action="setup">
                <g:render template="/templates/configuration/trigger"/>
                <div class="buttons">
