...
grails.project.dependency.resolution = {
    ...
    String ddmoreMetadataIntegrationServiceVersion = "0.1.2-SNAPSHOT"
    ...
    dependencies {
        ...
        compile("eu.ddmore.metadata:lib-metadata:1.5-SNAPSHOT") {
            // can't use Spring 4.1 yet, fall back on Grails defaults
            excludes 'spring-core', 'spring-context'
        }

        compile "net.biomodels.jummp:AnnotationStore:0.2.7"
